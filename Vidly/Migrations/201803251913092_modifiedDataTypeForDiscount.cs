namespace Vidly.Migrations
{
    ...
    public partial class modifiedDataTypeForDiscount : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.Customers", "MembershipTypeId", c => c.Byte(nullable: false));
            AlterColumn("dbo.MembershipTypes", "Discount", c => c.Int(nullable: false));
        ...
        public override void Down()
        {
            ...
            AlterColumn("dbo.MembershipTypes", "Discount", c => c.Byte(nullable: false));
